...
# CHICKEN - BLUE
   if chickenColor == "blue":
    print("\033[33m" "Is the Villager you're looking for named Ken?"
            "\033[0m")
    print()
    yn = input("Yes or No? ").lower()
    if yn == "yes":
...
# CHICKEN - RED
   if chickenColor == "red":
    print("\033[33m" "Is the Villager you're looking for named Benedict?"
            "\033[0m")
    print()
    yn = input("Yes or No? ").lower()
    if yn == "yes":
...
# CHICKEN - PURPLE
   if chickenColor == "purple":
    print("\033[33m" "Is the Villager you're looking for named Becky?"
            "\033[0m")
    print()
    yn = input("Yes or No? ").lower()
    if yn == "yes":
...
# CHICKEN - WHITE
   if chickenColor == "white":
    ...
    if chickenGender == "girl":
      print("\033[32m" "Is the Villager you're looking for named Ava?"
            "\033[0m")
      print()
      yn = input("Yes or No? ").lower()
      if yn == "yes":
    ...
    if chickenGender == "boy":
      ...
      if hc == "yes":
        print("\033[32m" "Is the Villager you're looking for named Knox?"
            "\033[0m")
        print()
        yn = input("Yes or No? ").lower()
        if yn == "yes":
        ...
        if yn == "no":
          ...
          print("Sounds like a you problem.")
      if hc == "no":
        print("\033[32m" "Is the Villager you're looking for named Goose?"
            "\033[0m")
        print()
        yn = input("Yes or No? ").lower()
        if yn == "yes":
  ...
  if eagleColor == "white":
    ...
    if eagleGender == "girl":
      ...
      if yn == "no":
        ...
        print("Sounds like a you problem.")
    if eagleGender == "boy":
      print("\033[32m" "Is the Villager you're looking for named Apollo?"
            "\033[0m")
      print()
      yn = input("Yes or No? ").lower()
      if yn == "yes":
...
# EAGLE - BLUE
  if eagleColor == "blue":
    ...
    if sob == "yes":
      print("\033[32m" "Is the Villager you're looking for named Pierce?"
            "\033[0m")
      print()
      yn = input("Yes or No? ").lower()
      if yn == "yes":
      ...
      if yn == "no":
        ...
        print("Sounds like a you problem.")
    if sob == "no":
      print("\033[32m" "Is the Villager you're looking for named Sterling?"
            "\033[0m")
      print()
      yn = input("Yes or No? ").lower()
      if yn == "yes":
...
# DOG - PINK
  if dogColor == "pink":
    print("\033[33m" "Is the Villager you're looking for named Cookie?"
            "\033[0m")
    print()
    yn = input("Yes or No? ").lower()
    if yn == "yes":
...
# DOG - RED
  if dogColor == "red":
    print("\033[33m" "Is the Villager you're looking for named Cherry?"
            "\033[0m")
    print()
    yn = input("Yes or No? ").lower()
    if yn == "yes":
...
# DOG - WHITE
  if dogColor == "white":
    ...
    "\033[30m""\033[37m""? ""\033[0m").lower()
    if dogGender == "girl":
        print("\033[33m" "Is the Villager you're looking for named Portia?"
            "\033[0m")
        print()
        yn = input("Yes or No? ").lower()
        if yn == "yes":
    ...
    if dogGender == "boy":
      ...
      if ge == "yes":
        print("\033[33m" "Is the Villager you're looking for named Lucky?"
            "\033[0m")
        print()
        yn = input("Yes or No? ").lower()
        if yn == "yes":
      ...
      if ge == "no":
        ...
        if ghd == "yes":
          print("\033[33m" "Is the Villager you're looking for named Marcel?"
            "\033[0m")
          print()
          yn = input("Yes or No? ").lower()
          if yn == "yes":
        ...
        if ghd == "no":
          ...
          if bs == "yes":
            ...
            if yn == "no":
              ...
              print("Sounds like a you problem.")
          if bs == "no":
            print("\033[33m" "Is the Villager you're looking for named Walker?"
            "\033[0m")
            print()
            yn = input("Yes or No? ").lower()
            if yn == "yes":
...
# GORILLA - BROWN
  if gorillaColor == "brown":
    ...
    if gorillaGender == "girl":
      ...
      if pop == "pink":
        ...
        if yn == "no":
          ...
          print("Sounds like a you problem.")
      if pop == "purple":
        print("\033[31m" "Is the Villager you're looking for named Violet?"
            "\033[0m")
        print()
        yn = input("Yes or No? ").lower()
        if yn == "yes":
    ...
    if gorillaGender == "boy":
      ...
      if mm == "yes":
        print("\033[31m" "Is the Villager you're looking for named Boone?"
            "\033[0m")
        print()
        yn = input("Yes or No? ").lower()
        if yn == "yes":
      ...
      if mm == "no":
        ...
        if rrs == "yes":
          ...
          if yn == "no":
            ...
            print("Sounds like a you problem.")
        if rrs == "no":
          print("\033[31m" "Is the Villager you're looking for named Louie?"
            "\033[0m")
          print()
          yn = input("Yes or No? ").lower()
          if yn == "yes":
  ...
  if rabbitColor == "white":
    ...
    if rer == "no":
      ...
      if rwm == "no": 
        ...
        print()
        if bhr == "yes":
          print("\033[37m" "Is the Villager you're looking for named Gabi?"
            "\033[0m")
          print()
          yn = input("Yes or No? ").lower()
          if yn == "yes":
...
# RHINO - GRAY
  if rhinoColor == "gray":
    print()
    print("\033[30m" "Is the Villager you're looking for named Tank?"
            "\033[0m")
    print()
    yn = input("Yes or No? ").lower()
    if yn == "yes":
...
# SHEEP - BROWN
  if sheepColor == "brown":
    ...
    if ow == "no":
      print()
      print("\033[34m" "Is the Villager you're looking for named Willow?"
            "\033[0m")
      print()
      yn = input("Yes or No? ").lower()
      if yn == "yes":
